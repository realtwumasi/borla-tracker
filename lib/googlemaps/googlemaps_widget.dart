  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: StreamBuilder<List<RequestFromPersonalRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<RequestFromPersonalRecord>
                  googleMapRequestFromPersonalRecordList = snapshot.data!;
              // Return an empty Container when the item does not exist.
              if (snapshot.data!.isEmpty) {
                return Container();
              }
              final googleMapRequestFromPersonalRecord =
                  googleMapRequestFromPersonalRecordList.isNotEmpty
                      ? googleMapRequestFromPersonalRecordList.first
                      : null;
