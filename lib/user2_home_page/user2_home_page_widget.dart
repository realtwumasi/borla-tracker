...
class User2HomePageWidget extends StatefulWidget {
  const User2HomePageWidget({super.key});

  static String routeName = 'user2_homePage';
  static String routePath = '/user2HomePage';

  @override
  State<User2HomePageWidget> createState() => _User2HomePageWidgetState();
}

class _User2HomePageWidgetState extends State<User2HomePageWidget> {
  late User2HomePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => User2HomePageModel());
